...
class AgoraAccessToken {
  ...
  from_string(origin_token) {
    ...
    for (let i = 0; i < service_count; i++) {
      ...
      let service = new AgoraAccessToken.kServices[service_type]();
...
AgoraAccessToken.kServices = {};
AgoraAccessToken.kServices[kApaasServiceType] = ServiceApaas;
AgoraAccessToken.kServices[kChatServiceType] = ServiceChat;
AgoraAccessToken.kServices[kFpaServiceType] = ServiceFpa;
AgoraAccessToken.kServices[kRtcServiceType] = ServiceRtc;
AgoraAccessToken.kServices[kRtmServiceType] = ServiceRtm;
