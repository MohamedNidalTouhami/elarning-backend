const AccessToken = require('./AgoraAccessToken').AgoraAccessToken;
const ServiceRtc = require('./AgoraAccessToken').ServiceRtc;
const ServiceRtm = require('./AgoraAccessToken').ServiceRtm;
